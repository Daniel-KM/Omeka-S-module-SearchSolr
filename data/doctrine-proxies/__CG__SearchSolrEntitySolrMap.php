 ...
 */
class SolrMapping extends \SearchSolr\Entity\SolrMapping implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'solrNode', 'resourceName', 'fieldName', 'source', 'settings'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SolrMapping $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setSolrNode(\SearchSolr\Entity\SolrNode $solrNode)
    {
